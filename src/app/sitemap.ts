...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/webdesign-bamberg`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/webdesign-wuerzburg`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    ...blogPosts,
