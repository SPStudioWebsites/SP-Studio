...
const benefits = [
  {
    ...
    desc: "Als regionaler Anbieter aus Unterfranken verstehe ich die Schweinfurter Märkte, lokale Suchgewohnheiten und wie deine Zielgruppe tickt.",
  ...
  },
  {
    ...
    desc: "Ich baue keine Seiten, die nur existieren — sondern Seiten, die in Schweinfurt gefunden werden und Anfragen generieren.",
...
const checkList = [
  ...
  "Beratung in Schweinfurt & Umgebung möglich",
    ...
    "@graph": [
      {
        ...
        name: brand.name,
        url: "https://schnell-sichtbar.de/webdesign-schweinfurt",
        ...
        description:
          "Webdesign Schweinfurt – Professionelle Webseiten für lokale Betriebe in Schweinfurt und Umgebung.",
        priceRange: "€€",
      },
      {
        "@type": "FAQPage",
    ...
    <>
      ...
      <main id="main" className="relative">
        ...
        <section
          ...
          aria-label="Webdesign Schweinfurt"
        >
          <GradientOrbs />
          ...
          <div className="relative mx-auto grid w-full max-w-7xl gap-8 px-6 lg:grid-cols-12 lg:gap-4 lg:items-center">
            <div className="lg:col-span-7 xl:col-span-7">
              ...
              >
                Ich erstelle professionelle Webseiten für Handwerker, Dienstleister und KMUs in
                Schweinfurt und Umgebung — schnell, persönlich und ohne Agentur-Bürokratie.
              </p>

              {/* CTA */}
              <div
                className="mt-10 hero-enter"
              ...
              >
                <span>
                  <span className="font-semibold text-foreground">ø 14 Tage</span> Lieferzeit
                </span>
                <span>
                  <span className="font-semibold text-foreground">Festpreis</span> — keine Überraschungen
                </span>
                <span>
                  <span className="font-semibold text-foreground">Region</span> Schweinfurt &
                  Unterfranken
                </span>
              </div>

              {/* Feature grid — mobile only, desktop shows right column visual */}
              <div
                ...
                {featureCards.map(({ icon: Icon, text, grad }) => (
                  <div
                    ...
                    style={{
                      ...
                      boxShadow:
                        "inset 0 1px 0 rgba(255,255,255,0.08), 0 4px 24px rgba(0,0,0,0.25)",
                    }}
                  >
                    <div
                      ...
                      style={{
                        background:
                          "radial-gradient(ellipse at 30% 0%, rgba(255,255,255,0.06) 0%, transparent 60%)",
                      }}
                    />
                    <span
                    ...
                    <span className="relative text-xs font-medium leading-snug text-foreground/90">
                      {text}
                    </span>
                  </div>
                ))}
        ...
        {/* ── Warum lokal + Prozess + FAQ (gemeinsamer Hintergrundblock) ── */}
        <div
          className="relative"
          style={{
              ...
              <Reveal delay={0.3} className="mt-12">
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        "radial-gradient(ellipse at 50% 0%, rgba(255,45,143,0.12) 0%, transparent 60%)",
                    }}
                  />
                  <div
                    aria-hidden
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, transparent, rgba(255,45,143,0.5) 50%, transparent)",
                    }}
                  />
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-4">
                        <div
                          ...
                          style={{
                            boxShadow: "0 0 0 1.5px rgba(255,45,143,0.4), 0 4px 16px rgba(0,0,0,0.4)",
                          }}
                        >
                          <Image
                            src="/Über-Mich.jpeg"
                      ...
                      <h3 className="mt-3 font-display text-2xl font-semibold tracking-tight text-foreground md:text-3xl text-balance">
                        Webdesign für Schweinfurt —{" "}
                        <em className="font-display font-extrabold not-italic text-gradient">
                          kein anonymes Studio.
                        </em>
                      </h3>
                      <p className="mt-4 text-sm leading-relaxed text-muted text-pretty md:text-base">
                        Ich bin Simon — kein Praktikant, kein Callcenter, keine Weitervermittlung.
                        Wenn du eine Frage hast, schreibst du mir direkt. Ich kenne Unterfranken,
                        ich kenne die Betriebe hier, und ich baue Websites, die für echte Kunden
                        in Schweinfurt und Umgebung funktionieren.
                      </p>
                    </div>
                ...
                <div className="lg:col-span-5 lg:sticky lg:top-28 lg:self-start">
                  ...
                  <Reveal delay={0.2}>
                    <p className="mt-5 text-base text-muted md:text-lg text-pretty">
                      Du hast Fragen zu Webdesign in Schweinfurt? Schreib uns — wir antworten
