      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow: "inset 0 1px 0 rgba(255,255,255,0.08), 0 30px 80px -20px rgba(0,0,0,0.7)",
          }}
        >
          <div
            aria-hidden
                ...
                <div className="relative flex items-start gap-2.5">
                  <div className="flex flex-col items-center gap-1.5 pt-0.5">
                    <span
                      ...
                      style={{
                        color: r.highlight ? "transparent" : "rgba(255,255,255,0.3)",
                        backgroundImage: r.highlight ? "linear-gradient(135deg,#ff2d8f,#8b5cf6)" : "none",
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p
                      ...
                      style={{ color: r.highlight ? "#7ca9ff" : "rgba(255,255,255,0.45)" }}
                    >
                      {r.title}
                    </p>
